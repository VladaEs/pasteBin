...
const InputPasteName = (props)=>{
    ...
    return(
        ...
        <InputWrapper>
        <input type="text" {...props.validationOptions} {...props.register} className='w-full gap-5 bg-gray-50 border border-gray-300 dark:text-neutral-400 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block p-2.5  dark:bg-neutral-900 dark:border-neutral-700'/>
        </InputWrapper>
