...
const Header =()=>{
    return(
      <header>
      <nav className={`bg-white border-gray-200 px-4 lg:px-6 py-2.5 ${styles.backgroundHeader} `}>
          <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl ">
              <div className='flex flex-row'>
                  <img src="/images/pastebin.svg" className="mr-3 h-6 sm:h-9" alt="PASTEBIN Logo" />
                  <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">PASTEBIN</span>
                  </div>
